...
class OweDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        ...
        if(LOGIN_USER_TYPE == 'admin') {
            $columns = array(
                ['data' => 'company_id', 'name' => 'companies.id', 'title' => __('messages.admin.manage_owe_amounts.table.company_id'),'searchable' => false],
                ['data' => 'driver_company_name', 'name' => 'companies.name', 'title' =>__('messages.admin.manage_owe_amounts.table.company_name') ,'searchable' => false],
                ['data' => 'trip_ids', 'name' => 'trip_ids', 'title' => __('messages.admin.manage_owe_amounts.table.trip_ids'),'orderable' => false, 'searchable' => false],
                ['data' => 'owe_amount', 'name' => 'owe_amount', 'title' =>__('messages.admin.manage_owe_amounts.table.owe_amount'), 'searchable' => false],
            );

            $owe_columns = array(
                ['data' => 'remaining_owe_amount', 'name' => 'remaining_owe_amount', 'title' => __('messages.admin.manage_owe_amounts.table.remaining_owe_amount'), 'searchable' => false]
            );
        }
        else {
            $columns = array(
                ['data' => 'id', 'name' => 'users.id', 'title' => __('messages.admin.manage_owe_amounts.table.driver_id'),'searchable' => false],
                ['data' => 'first_name', 'name' => 'users.first_name', 'title' => __('messages.admin.manage_owe_amounts.table.driver_name'),'searchable' => false],
                ['data' => 'trip_ids', 'name' => 'trip_ids', 'title' => __('messages.admin.manage_owe_amounts.table.trips_ids'),'orderable' => false, 'searchable' => false],
            );
            if($this->filter_type != 'applied') {
                $owe_columns = array(['data' => 'owe_amount', 'name' => 'owe_amount', 'title' => __('messages.admin.manage_owe_amounts.table.owe_amount'), 'searchable' => false]);
            }
        }
