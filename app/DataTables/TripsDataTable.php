...
class TripsDataTable extends DataTable
{
    ...
    {
        $col_list_1 = [
            ['data' => 'id', 'name' => 'trips.id', 'title' => __('messages.admin.manage_trip.table.id')],
            ['data' => 'driver_name', 'name' => 'driver.first_name', 'title' =>  __('messages.admin.manage_trip.table.driver_name')],
            ['data' => 'rider_name', 'name' => 'rider.first_name', 'title' =>  __('messages.admin.manage_trip.table.rider_name')],
        ];
        ...
        $col_list_2 = [
            ...
            ['data' => 'trip_date', 'name' => 'trips.created_at', 'title' =>  __('messages.admin.manage_trip.table.trip_date')],
        ];

        $col_list_3 = [
            ['data' => 'car_name', 'name' => 'car_type.car_name', 'title' => __('messages.admin.manage_trip.table.vehicle_details')],
            ['data' => 'status', 'name' => 'trips.status', 'title' =>  __('messages.admin.manage_trip.table.status')],
            ['data' => 'action', 'name' => 'action', 'title' =>  __('messages.admin.manage_trip.table.action'), 'orderable' => false, 'searchable' => false, 'exportable' => false],
        ];

        if(LOGIN_USER_TYPE == 'company') {
            $payout_columns = array(
                ['data' => 'total_amount', 'name' => 'total_fare', 'title' =>  __('messages.admin.manage_trip.table.earned')],
            );              
            ...
            $company_columns = array(
                ['data' => 'company_name', 'name' => 'companies.name', 'title' =>  __('messages.admin.manage_trip.table.company_name')]
            );
        }
