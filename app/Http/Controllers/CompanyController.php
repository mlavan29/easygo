...
class CompanyController extends Controller
{
    ...
    public function updatePayoutPreference(Request $request)
    {
        ...
        $payout_preference->currency_code   =  $payout_method == 'Mtn' ? $request->currency : $payout_currency;
        ...
        $payout_preference->paypal_email    = $payout_method != 'Mtn' ? $payout_email : '';
        ...
        if ($payout_method == 'Mtn') {
            $payout_preference->mtn_tel = $request->mtn_tel;
        }
        ...
        $payout_credentials->payout_id = $payout_method == 'Mtn' ? $payout_preference->mtn_tel : $payout_email;
