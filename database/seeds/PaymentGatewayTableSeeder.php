...
class PaymentGatewayTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('payment_gateway')->insert([
            ...
            ['name' => 'paypal_id', 'value' => 'cabme@cabme.com', 'site' => 'Paypal'],
            ...
            ['name' => 'access_token', 'value' => 'access_token$sandbox$d7852qvvw6wj277m$71ad22f88418c3a7f17d824ad0786ffc', 'site' => 'Paypal'],
            ...
            ['name' => 'tokenization_key', 'value' => 'sandbox_jy9mwggn_q8v7ynjw9fssn4hy', 'site' => 'Braintree'],
            ['name' => 'merchant_account_id', 'value' => '', 'site' => 'Braintree'],
            ['name' => 'is_web_payment', 'value' => '0', 'site' => 'Common'],
