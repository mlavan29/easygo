...
@section('main')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                {{ __('messages.admin.manage_admin_page.add_admin_user') }}
            </h1>
            <ol class="breadcrumb">
                <li><a href="{{ url(LOGIN_USER_TYPE . '/dashboard') }}"><i class="fa fa-dashboard"></i>
                        {{ __('messages.admin.home') }}</a></li>
                <li><a href="{{ url(LOGIN_USER_TYPE . '/admin_user') }}">
                        {{ __('messages.admin.manage_admin_page.admin_users') }}</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"> {{ __('messages.admin.manage_admin_page.add_admin_user_form') }}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="input_username" class="col-sm-3 control-label">{{ __('messages.admin.manage_admin_page.form.username') }}<em
                            ...
                            <div class="form-group">
                                <label for="input_email" class="col-sm-3 control-label">{{ __('messages.admin.manage_admin_page.form.email') }}<em
                                        class="text-danger">*</em></label>
                            ...
                            <div class="form-group">
                                <label for="input_password" class="col-sm-3 control-label">{{ __('messages.admin.manage_admin_page.form.password') }}<em
                                        class="text-danger">*</em></label>
                                ...
                                <div class="col-md-7 col-sm-offset-1">
                                    <select class='form-control' id = 'input_country_code' name='country_code'>
                                        ...
                                        @foreach ($countries as $country_code)
                                            <option value="{{ @$country_code->id }}"
                                                {{ $country_code->phone_code == old('country_code') ? 'Selected' : '' }}>
                            ...
                            <div class="form-group">
                                <label for="input_role" class="col-sm-3 control-label">{{ __('messages.admin.manage_admin_page.form.role') }}<em
                                        class="text-danger">*</em></label>
                            ...
                            <div class="form-group">
                                <label for="input_status" class="col-sm-3 control-label">{{ __('messages.admin.manage_admin_page.form.status') }}<em
                                        class="text-danger">*</em></label>
