...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      {{ __('messages.admin.edit') }}  {{ __('messages.admin.manage_mobile_app_version.subtitle') }}
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">{{ __('messages.admin.manage_mobile_app_version.edit_mobile_app_version_form') }}</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
