...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        {{ __('messages.admin.cancel_reasons.edit_cancel_reason') }}
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">   {{ __('messages.admin.cancel_reasons.edit_title') }}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => 'admin/edit-cancel-reason/'.$result->id, 'class' => 'form-horizontal']) !!}
              ...
              <span class="text-danger">(*){{ __('messages.admin.fields_are_mandatory') }}</span>
                <div class="form-group">
                  <label for="input_value" class="col-sm-3 control-label">{{ __('messages.admin.cancel_reasons.form.reason') }}<em class="text-danger">*</em></label>
          ...
          <div class="panel" ng-init="translations = {{json_encode(old('translations') ?: @$result->translations)}}; removed_translations =  []; errors = {{json_encode($errors->getMessages())}}; " ng-cloak>
