...
@section('main')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                {{ __('messages.admin.cancel_reasons.title') }}
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> {{ __('messages.admin.cancel_reasons.title') }}</li>
            </ol>
        </section>
                        ...
                        <div class="box-header">
                            ...
                            @if (Auth::guard('admin')->user()->can('create_manage_reason'))
                                <div style="float:right;"><a class="btn btn-success"
                                        href="{{ url('admin/add-cancel-reason') }}">
                                        {{ __('messages.admin.cancel_reasons.add_cancel_reason') }}</a></div>
                            @endif
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
