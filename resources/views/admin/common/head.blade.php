...
<head>
  ...
  <title> {{ Helpers::meta((!isset($exception)) ? ucfirst(LOGIN_USER_TYPE) : '', 'title') }} </title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="description" content="{{ Helpers::meta((!isset($exception)) ? ucfirst(LOGIN_USER_TYPE) : '', 'description') }}">
  <meta name="keywords" content="{{ Helpers::meta((!isset($exception)) ? ucfirst(LOGIN_USER_TYPE) : '', 'keywords') }}">
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ url('admin_assets/dist/css/language.css') }}">
  ...
  @if (!isset($exception) && ucfirst(LOGIN_USER_TYPE) == 'admin/referral_settings')
    <link href="{{ url('admin_assets/bootstrap/css/bootstrap-toggle.min.css') }}" rel="stylesheet">
  @endif

  <link rel="stylesheet" href="{{ url('admin_assets/dist/css/jquery.multiselect.css') }}">
