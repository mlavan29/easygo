...
<div class="content-wrapper" ng-controller="company_management" ng-init="login_user_type ='{{ LOGIN_USER_TYPE }}'; company_doc=''; errors = {{ json_encode($errors->getMessages()) }};">
  ...
  <section class="content-header">
    <h1>
      {{ __('messages.admin.manage_company_page.edit_company') }}
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">{{ __('messages.admin.manage_company_page.edit_company_form') }}</h3>
          </div>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="input_password" class="col-sm-3 control-label">{{ __('messages.admin.manage_company_page.form.password') }}</label>
              <div class="col-md-7 col-sm-offset-1">
            ...
            <div class="form-group">
              <label for="input_status" class="col-sm-3 control-label">{{ __('messages.admin.manage_company_page.form.mobile_number') }}</label>
              <div class="col-md-7 col-sm-offset-1">
          ...
          <div class="box-footer text-center">
            ...
            @if(LOGIN_USER_TYPE == 'company')
            <a href="{{url(LOGIN_USER_TYPE.'/edit_company/'.$result->id)}}"><span class="btn btn-default">{{ __('messages.admin.cancel') }}</span></a>
            @else
