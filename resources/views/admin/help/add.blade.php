...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" ng-controller="help">
    ...
    <section class="content-header">
      <h1>
        {{ __('messages.admin.manage_help.add_help') }}
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">     {{ __('messages.admin.manage_help.add_help_form') }}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <span class="text-danger">(*){{__('messages.admin.fields_are_mandatory')}}</span>
               <div class="form-group">
                  <label for="input_language" class="col-sm-3 control-label"> {{ __('messages.admin.manage_help.form.language') }}<em class="text-danger">*</em></label>
