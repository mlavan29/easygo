...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" ng-controller="help">
    ...
    <section class="content-header">
      <h1>
        {{ __('messages.admin.manage_help.edit_help') }}
      </h1>
      <ol class="breadcrumb">
        <li><a href="../dashboard"><i class="fa fa-dashboard"></i> {{ __('messages.admin.home') }}</a></li>
        <li><a href="../help">{{ __('messages.admin.manage_help.help') }}</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">        {{ __('messages.admin.manage_help.edit_help_form') }}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => 'admin/edit_help/'.$result->id, 'class' => 'form-horizontal']) !!}
              ...
              <span class="text-danger">(*){{__('messages.admin.fields_are_mandatory')}}</span>
                <div class="form-group">
                  <label for="input_category" class="col-sm-3 control-label">       {{ __('messages.admin.manage_help.form.category') }}<em class="text-danger">*</em></label>
                ...
                <div class="form-group">
                  <label for="input_subcategory" class="col-sm-3 control-label"> {{ __('messages.admin.manage_help.form.subcategory') }}</label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_question" class="col-sm-3 control-label">{{ __('messages.admin.manage_help.form.question') }}<em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                    {!! Form::text('question', $result->question, ['class' => 'form-control', 'id' => 'input_question', 'placeholder' => __('messages.admin.manage_help.form.question')]) !!}
                    <span class="text-danger">{{ $errors->first('question') }}</span>
                  </div>
                </div>
                <div class="form-group">
                  <label for="input_answer" class="col-sm-3 control-label">{{ __('messages.admin.manage_help.form.answer') }}<em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_suggested" class="col-sm-3 control-label">{{ __('messages.admin.manage_help.form.suggested') }}</label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_status" class="col-sm-3 control-label">{{ __('messages.admin.manage_help.form.status') }}<em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="panel" ng-init="translations = {{json_encode(old('translations') ?: $result->translations)}}; removed_translations =  []; errors = {{json_encode($errors->getMessages())}}; result_translations = {{json_encode($result->translations)}}" ng-cloak>
                  ...
                  <div class="panel-body" ng-init="languages = {{json_encode($languages)}}">
                    ...
                    <div class="row" ng-repeat="translation in translations">
                      ...
                      <div class="form-group">
                        <label for="input_language_@{{$index}}" class="col-sm-3 control-label">{{ __('messages.admin.manage_help.form.language') }}<em class="text-danger">*</em></label>
                        <div class="col-md-7 col-sm-offset-1">
                      ...
                      <div class="form-group">
                        <label for="input_name_@{{$index}}" class="col-sm-3 control-label">{{ __('messages.admin.manage_help.form.question') }}<em class="text-danger">*</em></label>
                        <div class="col-md-7 col-sm-offset-1">
                      ...
                      <div class="form-group"  ng-init="multiple_editors($index)">
                        <label for="input_content_@{{$index}}" class="col-sm-3 control-label">{{ __('messages.admin.manage_help.form.answer') }}<em class="text-danger">*</em></label>
                        <div class="col-md-7 col-sm-offset-1">
                    ...
                    <div class="row" ng-show="(translations | checkActiveTranslation: languages).length <  {{count($languages) - 1}}">
                      <div class="col-sm-10 col-sm-offset-1 text-center">
                        <button type="button" class="btn btn-info" ng-click="translations.push({locale:''});" >
                          <i class="fa fa-plus"></i> {{ __('messages.admin.manage_help.add_translation') }}
                        </button>
                      </div>
                    </div>
                  </div>
              ...
              <div class="box-footer text-center">
                <button type="submit" class="btn btn-info" name="submit" value="submit">{{__('messages.admin.submit')}}</button>
                 <button type="submit" class="btn btn-default" name="cancel" value="cancel">{{__('messages.admin.canel')}}</button>
              </div>
              <!-- /.box-footer -->
            {!! Form::close() !!}
          </div>
