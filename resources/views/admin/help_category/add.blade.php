...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        {{ __('messages.admin.manage_help.add_help_category') }}
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashboard"><i class="fa fa-dashboard"></i> {{ __('messages.admin.home') }}</a></li>
        <li><a href="help_category">    {{ __('messages.admin.manage_help.help_category') }}</a></li>
        ...
        <div class="col-md-12" >
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">    {{ __('messages.admin.manage_help.add_help_category_form') }}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => 'admin/add_help_category', 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*){{__('messages.admin.fields_are_mandatory')}}</span>
              <div class="form-group">
                  <label for="input_status" class="col-sm-3 control-label"> {{ __('messages.admin.manage_help.form.language') }}<em class="text-danger">*</em></label>
                ...
                <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">{{ __('messages.admin.manage_help.form.name') }}<em class="text-danger">*</em></label>

                  <div class="col-md-7 col-sm-offset-1">
                    {!! Form::text('name', '', ['class' => 'form-control', 'id' => 'input_name', 'placeholder' =>  __('messages.admin.manage_help.form.name')]) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    {!! Form::textarea('description', '', ['class' => 'form-control', 'id' => 'input_description', 'placeholder' => __('messages.admin.manage_help.form.description') , 'rows' => 3]) !!}
              ...
              <div class="panel" ng-init="translations = {{json_encode(old('translations') ?: array())}}; removed_translations =  []; errors = {{json_encode($errors->getMessages())}};" ng-cloak>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row" ng-repeat="translation in translations">
                      ...
                      <div class="form-group">
                        <label for="input_name_@{{$index}}" class="col-sm-3 control-label">{{__('messages.admin.manage_help.form.name') }}<em class="text-danger">*</em></label>
                        <div class="col-md-7 col-sm-offset-1">
                      ...
                      <div class="form-group"  ng-init="multiple_editors($index)">
                        <label for="input_content_@{{$index}}" class="col-sm-3 control-label">{{__('messages.admin.manage_help.form.description') }}</label>
                        <div class="col-md-7 col-sm-offset-1">
