...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        {{__('messages.admin.manage_help.edit_help_category') }}
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">{{__('messages.admin.manage_help.edit_help_category_form') }}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => 'admin/edit_help_category/'.$result->id, 'class' => 'form-horizontal']) !!}
              <div class="box-body">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row" ng-repeat="translation in translations">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-offset-1">
                          {!! Form::text('translations[@{{$index}}][name]', '@{{translation.name}}', ['class' => 'form-control', 'id' => 'input_name_@{{$index}}', 'placeholder' => __('messages.admin.manage_help.form.name') ]) !!}
