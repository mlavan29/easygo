                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div style="float:right;"><a class="btn btn-success"
                                    href="{{ url('admin/add_help_subcategory') }}">
                                    {{ __('messages.admin.manage_help.add_help_sub_category') }}</a></div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            {!! $dataTable->table() !!}
