...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
 {{ __('messages.admin.manage_language.edit_language')}}
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title"> {{ __('messages.admin.manage_language.edit_language_form')}}</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                {!! Form::text('name', old('name',$result->name), ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => __('messages.admin.manage_language.form.name')]) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                {!! Form::text('value', old('value',$result->value), ['class' => 'form-control', 'id' => 'input_value', 'placeholder' => __('messages.admin.manage_language.form.value')]) !!}
