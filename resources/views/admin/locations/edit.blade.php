...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      {{ __('messages.admin.locations.edit_location') }}
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title"> {{ __('messages.admin.locations.edit_title') }}</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          ...
          <div class="box-body" ng-init="formatted_coords={{ json_encode(old('formatted_coords',$result->co_ordinates)) }};coordinates=[]">
            ...
            <div class="form-group">
              <label for="input_name" class="col-sm-3 control-label">
                {{ __('messages.admin.locations.form.name') }} <em class="text-danger">*</em>
              </label>
            ...
            <div class="form-group">
              <label for="input_status" class="col-sm-3 control-label">
                {{ __('messages.admin.locations.form.status') }} <em class="text-danger">*</em>
              </label>
              <div class="col-md-7 col-sm-offset-1">
