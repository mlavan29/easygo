...
@section('main')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                {{ __('messages.admin.manage_static_pages.title') }}
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> {{ __('messages.admin.manage_static_pages.static_page') }}</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            @if (auth()->user()->can('create_static_page'))
                                <div style="float:right;"><a class="btn btn-success"
                                        href="{{ url('admin/add_page') }}">{{ __('messages.admin.manage_static_pages.add_page') }}</a>
                                </div>
                            @endif
                        </div>
                        <!-- /.box-header -->
