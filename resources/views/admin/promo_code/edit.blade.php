...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        {{ __('messages.admin.manage_wallet_and_promo.edit_promo_code_form') }}
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> {{ __('messages.admin.manage_wallet_and_promo.edit_promo_code_form') }}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => 'admin/edit_promo_code/'.$result->id, 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*){{ __('messages.admin.fields_are_mandatory') }}</span>
               <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    {!! Form::text('code',$result->code, ['class' => 'form-control', 'id' => 'input_promo_code', 'placeholder' => {{ __('messages.admin.manage_wallet_and_promo.form.promo_code') }}]) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    {!! Form::text('amount',$result->original_amount, ['class' => 'form-control', 'id' => 'input_amount', 'placeholder' => {{ __('messages.admin.manage_wallet_and_promo.form.amount') }}]) !!}
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    {!! Form::text('expire_date',$result->expire_date_mdy, ['class' => 'form-control', 'id' => 'input_expired_at', 'placeholder' => {{ __('messages.admin.manage_wallet_and_promo.form.expire_date') }}, 'autocomplete' => 'off']) !!}
