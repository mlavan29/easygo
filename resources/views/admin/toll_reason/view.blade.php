...
@section('main')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                {{ __('messages.admin.manage_additional_reasons.title') }}
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> {{ __('messages.admin.manage_additional_reasons.title') }}</li>
            </ol>
        </section>
        <!-- Main content -->
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div style="float:right;"><a class="btn btn-success"
                                    href="{{ url('admin/add-additional-reason') }}">{{__('messages.admin.manage_additional_reasons.add_additional_reason')}}</a></div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            {!! $dataTable->table() !!}
