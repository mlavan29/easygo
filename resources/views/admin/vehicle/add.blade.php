...
<div class="content-wrapper" ng-controller="vehicle_management">
	<section class="content-header" ng-init='vehicle_id=0'>
		<h1>
			{{ __('messages.admin.manage_vehicles.add_vehicles') }}
		</h1>
		<ol class="breadcrumb">
			<li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> {{ __('messages.admin.home') }}</a></li>
			<li><a href="{{ url(LOGIN_USER_TYPE.'/vehicle') }}">      {{ __('messages.admin.manage_vehicles.vehicles') }}</a></li>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">	{{ __('messages.admin.manage_vehicles.add_vehicles') }}</h3>
					</div>
					...
					<div class="box-body">
						...
						@if (LOGIN_USER_TYPE!='company')
							<div class="form-group">
								<label for="input_company" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.company_name') }} <em class="text-danger">*</em></label>
						...
						@endif
						<div class="form-group">
							<label for="input_company" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.driver_name') }} <em class="text-danger">*</em></label>
						...
						<div class="form-group">
							<label for="input_status" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.status') }} <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
			              <label for="input_status" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.make') }} <em class="text-danger">*</em></label>
			              <div class="col-md-7 col-sm-offset-1">
			            ...
			            <div class="form-group">
			              <label for="input_status" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.model') }} <em class="text-danger">*</em></label>
			              <div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group cls_vehicle">
							<label for="vehicle_type" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.vehicle_type') }}<em class="text-danger">*</em></label>
						...
						<div class="form-group">
							<label for="default" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.default') }} <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1 form-check" style="padding-top: 6px;">
								...
								<span style="color:gray;font-style: italic;"> * {{__('messages.admin.manage_vehicles.form.default_note')}}</span>
							</div>
						</div>
						<div class="form-group">
							<label for="handicap" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.handicap_accessibility_available') }}<em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1 form-check" style="padding-top: 6px;">
						...
						<div class="form-group">
							<label for="child_seat" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.child_seat_accessibility_available') }}<em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1 form-check" style="padding-top: 6px;">
						...
						<div class="form-group">
							<label for="request_from" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.request_form')}} <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1 form-check" style="padding-top: 6px;">
								...
								<span style="color:gray;font-style: italic;"> * {{ __('messages.admin.manage_vehicles.form.request_form_note')}} </span>
							</div>
						</div>
						<div class="form-group">
							<label for="vehicle_number" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.vehicle_number')}} <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('vehicle_number','', ['class' => 'form-control', 'id' => 'vehicle_number', 'placeholder' => __('messages.admin.manage_vehicles.form.vehicle_number')]) !!}
								<span class="text-danger">{{ $errors->first('vehicle_number') }}</span>
							</div>
						</div>
						<div class="form-group">
							<label for="color" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.color')}} <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('color','', ['class' => 'form-control', 'id' => 'color', 'placeholder' => __('messages.admin.manage_vehicles.form.color')]) !!}
								<span class="text-danger">{{ $errors->first('color') }}</span>
							</div>
						</div>
						<div class="form-group">
							<label for="year" class="col-sm-3 control-label">{{ __('messages.admin.manage_vehicles.form.year')}} <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('year','', ['class' => 'form-control', 'id' => 'year', 'placeholder' => __('messages.admin.manage_vehicles.form.year'),'autocomplete' =>'off']) !!}
						...
						<div class="form-group" ng-repeat="doc in vehicle_doc" ng-cloak ng-if="vehicle_doc">
							...
							<div class="form-group">
							<label class="col-sm-3 control-label" ng-if="doc.expiry_required =='1'">{{__('messages.admin.manage_vehicles.form.expire_date')}} <em class="text-danger">*</em></label>
							...
							<div class="form-group">
							<label class="col-sm-3 control-label">@{{doc.document_name}} {{__('messages.admin.manage_vehicles.form.status')}} <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
					...
					<div class="box-footer text-center">
						...
						<a href="{{url(LOGIN_USER_TYPE.'/vehicle')}}"><span class="btn btn-default">{{ __('messages.admin.cancel') }}</span></a>
					</div>
					{!! Form::close() !!}
				</div>
			</div>
