...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{__('messages.admin.manage_wallet_and_promo.wallet')}}</li>
    </ol>
  </section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <div style="float:right;"><a class="btn btn-success" href="{{ route('add_wallet',['user_type' => $user_type]) }}">{{  __('messages.admin.manage_wallet_and_promo.add_wallet')}} </a></div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            {!! $dataTable->table() !!}
