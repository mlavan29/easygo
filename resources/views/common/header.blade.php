<header>
  <div class="fixed-header" id=header>
    <div class="container">
      ...
      <a href="{{ url('/') }}"  class="pull-left logo-link"><img style="width: 80px;background-color: white;    margin-top: 2px;height: 80px !important;" src="{{ $logo_url }}"></a>
      <ul  class="header-left-link">
        <li><a href="{{ url('signup_rider') }}">{{trans('messages.footer.ride')}}</a></li>
      ...
      <div class="pull-right">
        ...
        <ul class="header-right-link">
          ...
          @else
          <li>
            <a href="{{ @Auth::user()->user_type == 'Rider' ? url('profile') : url('driver_profile') }}">{{ @Auth::user()->first_name }} {{ @Auth::user()->last_name }}</a></li>
          ...
          <div class="nav-div">
           ...
           <p class="head-logo pull-left menu_head"><img src="{{ $logo_url }}"></p>
