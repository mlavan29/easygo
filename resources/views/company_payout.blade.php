...
<div class="content-wrapper" ng-controller="payout_preferences">
							...
							<tr id="add_payout_method_section">
								<td colspan="4">
									...
									<span class="text-muted lang-left">
										@lang('messages.account.direct_deposit'), <span>Mtn,PayPal </span><span class="lang-left">etc...</span>
									</span>
								</td>
							</tr>
							</tfoot>
	...
	<div class="modal poppayout" id="payout_popup-mtn" aria-hidden="false" tabindex="-1">
		<div id="modal-add-payout-set-address" class="modal-content">
			...
			{!! Form::open(['url' => route('company.update_preference') ,'class' => 'modal-add-payout-pref', 'method' => 'POST', 'id' => 'payout_mtn']) !!}
			<input type="hidden" name="address1" ng-value="address1" >
			<input type="hidden" name="address2" ng-value="address2" >
			<input type="hidden" name="city" ng-value="city" >
			<input type="hidden" name="country" ng-value="country" >
			...
			<div>
				<div class="form-group">
					<label> @lang('messages.account.mtn_tel') <em class="text-danger">*</em></label>
					{!! Form::text('mtn_tel',old('mtn_tel'), ['class' => 'form-control', 'id' => 'mtn_tel', 'placeholder' => trans('messages.account.mtn_tel')]) !!}
					<span class="text-danger">{{ $errors->first('mtn_tel') }}</span>
				</div>
			</div>

			<div class="panel-footer payout_footer">
				<button type="button" class="btn btn-primary" ng-click="nextStep('update_mtn')"> @lang('messages.account.submit') </button>
			</div>
			{!! Form::close() !!}
