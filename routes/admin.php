...
Route::group(['prefix' => (LOGIN_USER_TYPE=='company')?'company':'admin', 'middleware' =>'admin_guest'], function () {
	...
	Route::get('api_credentials', 'ApiCredentialsController@index')->middleware('admin_can:manage_api_credentials');
	Route::post('api_credentials_update','ApiCredentialsController@update')->name('api_credential.update');
