...
Route::match(['post','get'],'payment/verify', 'PaymentController@verify')->name('payment.verify');
Route::any('mtnmomo_callback','PaymentController@mtnCallbackCollection')->name('mtn_momo.callback_url');
Route::any('mtnmomo_disbursement_callback','PaymentController@mtnCallbackDisbursement')->name('mtn_momo.disbursement_callback_url');
...
Route::post('delete-user', 'TokenAuthController@deleteUser');
...
Route::group(['middleware' => 'jwt.verify'], function () {
	...
	// Driver Only APIs
	Route::post('start_schedule_trip','TripController@start_schedule_trip');
