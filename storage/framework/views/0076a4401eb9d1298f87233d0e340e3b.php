                            ...
                            <ul>
                                <li>
                                    <?php if($app_links[0]->value != ''): ?>
                                        <a href="<?php echo e($app_links[0]->value); ?>" target="_blank"><img src="images/new/app.png"
                                                alt="app"></a>
                                    <?php endif; ?>
                                </li>
                                <li>
            ...
            <div class="container">
                <?php if(Auth::user() == null): ?>
                    <div class="col-lg-12 alllogintop">
                        <?php echo e(Form::open(['url' => 'driver_register', 'class' => ''])); ?>
                        ...
                        <?php if(Auth::user() == null): ?>
                            <div class="col-lg-4">
                                <div class="allloginone">
                                    ...
                                    <a href="<?php echo e(url('signup_rider')); ?>"><?php echo e(trans('messages.home.siginup')); ?> <img
                            ...
                            <div class="col-lg-4">
                                <div class="allloginone">
                                    ...
                                    <a href="<?php echo e(url('signup_driver')); ?>"><?php echo e(trans('messages.home.siginup')); ?> <img
                                            src="images/new/arrow-right.svg" alt="arrow"></a>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if(Auth::guard('company')->user() == null): ?>
                            <div class="col-lg-4">
                                <div class="allloginone">
                                    ...
                                    <a href="<?php echo e(url('signup_company')); ?>"><?php echo e(trans('messages.home.siginup')); ?> <img
                                            src="images/new/arrow-right.svg" alt="arrow"></a>
                                </div>
                            </div>
                        <?php endif; ?>
                ...
                <div class="col-lg-12 allloginbottom1">
                    <a href="<?php echo e(url('ride')); ?>"><?php echo e(trans('messages.home.reason')); ?> <img
                            src="images/new/arrow-right.svg" alt="arrow"></a>
                </div>
            </div>
        </div>
                ...
                <div class="row displayflex">
                    ...
                    <div class="col-lg-6">
                        <div class="cls_sectiononetxt">
                            <h4 class="text-twotruncate"><?php echo e(trans('messages.home.drive_you')); ?>

                                <?php echo e(trans('messages.home.you_need')); ?></h4>
                            <p class="text-threetruncate"><?php echo e(trans('messages.home.drive_with')); ?>

                                <?php echo e($site_name); ?><?php echo e(trans('messages.home.goals')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="cls_arrivingin">
                            ...
                            <p><?php echo e(trans('messages.home.city_with')); ?> <?php echo e($site_name); ?>

                                <?php echo e(trans('messages.home.city_with_content')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="cls_arrivingin">
                            ...
                            <p><?php echo e(trans('messages.home.backseat')); ?>

                                <?php echo e($site_name); ?><?php echo e(trans('messages.home.designed')); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('templatesign', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mahen\OneDrive\Desktop\JEYIT SOLUTIONS\Laravel Projects\EasyGo\Project_Files\resources\views/home/home.blade.php ENDPATH**/ ?>