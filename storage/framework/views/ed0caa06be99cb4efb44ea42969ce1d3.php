			...
			<div class="register-container">
				<div class="register">
					<form action="<?php echo e(url('admin/authenticate')); ?>" method="post">
						...
						<h2>LOGIN TO  <img src="<?php echo e($logo_url); ?>" class="image-cls"></h2>
...
<?php /**PATH C:\Users\mahen\OneDrive\Desktop\JEYIT SOLUTIONS\Laravel Projects\EasyGo\Project_Files\resources\views/admin/login.blade.php ENDPATH**/ ?>